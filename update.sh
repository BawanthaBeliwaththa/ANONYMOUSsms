@@ -5,6 +5,7 @@ echo -e "\e[4;31m White Hat !!! \e[0m"
...
echo -e "\e[4;34mTG Group ~> @VIP Hackz\e[0m" #underline+blue
echo -e "\e[1;34mFor Any Queries Mail Us!!!\e[0m"
echo -e "\e[1;32mTelegram: @MrWhiteHatBAWA" #yellow
...
git clone https://github.com/MrWhieHatBAWA/ANONYMOUSsms.git
